...
const Landing: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const handleScrollStart = () => {
      ...
      }, 150); // Remove class after scroll ends
    };
  ...
  // Ultra-minimal intersection observer for critical performance
  useEffect(() => {
      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            ...
            observer.unobserve(entry.target); // Unobserve immediately after animation
          }
        });
      },
      { 
        threshold: 0.05, // Lower threshold for earlier trigger
        rootMargin: '50px' // Smaller margin for better performance
      }
    );
  ...
  // Memoize the InteractiveCampusMap to prevent unnecessary re-renders
  const memoizedCampusMap = useMemo(() => (
  ...
  return (
    <div className="min-h-screen bg-gray-50" style={{ contain: 'layout style paint' }}>
      ...
      <nav className="absolute top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-md shadow-sm" style={{ contain: 'layout style paint' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center">
              <div className="flex-shrink-0 flex items-center">
                <div className="w-12 h-12 bg-gradient-to-r from-green-500 via-blue-500 to-purple-600 rounded-xl flex items-center justify-center shadow-lg btn-hover-scale">
      ...
      <section id="pillars" className="py-20 bg-white relative overflow-hidden scroll-optimized" style={{ contentVisibility: 'auto', containIntrinsicSize: 'auto 800px' }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {/* Energy Efficiency */}
            <div className="group bg-gradient-to-br from-yellow-50 to-orange-50 rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-shadow duration-200 hover-lift animate-on-scroll" style={{ contain: 'layout style paint' }}>
              <div className="text-center">
                <div className="w-20 h-20 mx-auto mb-6 bg-gradient-to-r from-yellow-400 to-orange-500 rounded-3xl flex items-center justify-center btn-hover-scale">
            ...
            {/* Water Conservation */}
            <div className="group bg-gradient-to-br from-blue-50 to-cyan-50 rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-shadow duration-200 hover-lift animate-on-scroll" style={{ contain: 'layout style paint' }}>
              <div className="text-center">
                <div className="w-20 h-20 mx-auto mb-6 bg-gradient-to-r from-blue-400 to-cyan-500 rounded-3xl flex items-center justify-center btn-hover-scale">
                  <span className="text-4xl">💧</span>
                </div>
            ...
            {/* Waste Management */}
            <div className="group bg-gradient-to-br from-green-50 to-emerald-50 rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-shadow duration-200 hover-lift animate-on-scroll" style={{ contain: 'layout style paint' }}>
              <div className="text-center">
                <div className="w-20 h-20 mx-auto mb-6 bg-gradient-to-r from-green-400 to-emerald-500 rounded-3xl flex items-center justify-center btn-hover-scale">
            ...
            {/* Green Mobility */}
            <div className="group bg-gradient-to-br from-purple-50 to-pink-50 rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-shadow duration-200 hover-lift animate-on-scroll" style={{ contain: 'layout style paint' }}>
              <div className="text-center">
                <div className="w-20 h-20 mx-auto mb-6 bg-gradient-to-r from-purple-400 to-pink-500 rounded-3xl flex items-center justify-center btn-hover-scale">
                  <span className="text-4xl">🚶</span>
                </div>
      ...
      <section id="campus-map" className="py-20 bg-gradient-to-br from-gray-50 to-blue-50 scroll-optimized" style={{ contentVisibility: 'auto', containIntrinsicSize: 'auto 1000px' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
      ...
      <section id="journey" className="py-20 bg-gradient-to-br from-gray-50 to-blue-50 relative overflow-hidden scroll-optimized" style={{ contentVisibility: 'auto', containIntrinsicSize: 'auto 800px' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4 animate-on-scroll">
      ...
      <section className="py-20 bg-gradient-to-r from-green-600 to-blue-600 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {/* Energy Improvement */}
            <div className="bg-white/10 backdrop-blur-md rounded-3xl p-8 border border-white/20 hover-lift transition-transform duration-300 animate-on-scroll">
              <div className="text-center">
      ...
      <div className="fixed bottom-6 right-6 z-40">
        <button 
          className="w-16 h-16 bg-gradient-to-r from-green-500 to-blue-600 rounded-full shadow-2xl flex items-center justify-center text-white font-bold text-2xl hover:scale-110 transition-transform duration-300 will-change-transform"
          onClick={() => {
